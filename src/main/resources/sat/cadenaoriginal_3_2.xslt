...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:cfdi="http://www.sat.gob.mx/cfd/3" xmlns:ecc="http://www.sat.gob.mx/ecc" xmlns:psgecfd="http://www.sat.gob.mx/psgecfd" xmlns:donat="http://www.sat.gob.mx/donat" xmlns:divisas="http://www.sat.gob.mx/divisas" xmlns:detallista="http://www.sat.gob.mx/detallista" xmlns:ecb="http://www.sat.gob.mx/ecb" xmlns:implocal="http://www.sat.gob.mx/implocal" xmlns:terceros="http://www.sat.gob.mx/terceros" xmlns:iedu="http://www.sat.gob.mx/iedu" xmlns:ventavehiculos="http://www.sat.gob.mx/ventavehiculos" xmlns:pfic="http://www.sat.gob.mx/pfic" xmlns:tpe="http://www.sat.gob.mx/TuristaPasajeroExtranjero" xmlns:leyendasFisc="http://www.sat.gob.mx/leyendasFiscales" xmlns:spei="http://www.sat.gob.mx/spei" xmlns:nomina="http://www.sat.gob.mx/nomina" xmlns:registrofiscal="http://www.sat.gob.mx/registrofiscal" xmlns:pagoenespecie="http://www.sat.gob.mx/pagoenespecie" xmlns:consumodecombustibles="http://www.sat.gob.mx/consumodecombustibles" xmlns:valesdedespensa="http://www.sat.gob.mx/valesdedespensa" xmlns:aerolineas="http://www.sat.gob.mx/aerolineas" xmlns:notariospublicos="http://www.sat.gob.mx/notariospublicos">
  ...
  <!--
	...
	-->
  <xsl:include href="/srv/siiaf/sat/utilSat/utilerias.xslt"/>
  <!-- 
		En esta sección se define la inclusión de las demás plantillas de transformación para 
		la generación de las cadenas originales de los complementos fiscales 
	-->
  <xsl:include href="/srv/siiaf/sat/utilSat/ecc.xslt"/>
  <xsl:include href="/srv/siiaf/sat/utilSat/psgecfd.xslt"/>
  <xsl:include href="/srv/siiaf/sat/utilSat/donat11.xslt"/>
  <xsl:include href="/srv/siiaf/sat/utilSat/divisas.xslt"/>
  <xsl:include href="/srv/siiaf/sat/utilSat/ecb.xslt"/>
  <xsl:include href="/srv/siiaf/sat/utilSat/detallista.xslt"/>
  <xsl:include href="/srv/siiaf/sat/utilSat/implocal.xslt"/>
  <xsl:include href="/srv/siiaf/sat/utilSat/terceros11.xslt"/>
  <xsl:include href="/srv/siiaf/sat/utilSat/iedu.xslt"/>
  <xsl:include href="/srv/siiaf/sat/utilSat/ventavehiculos11.xslt"/>
  <xsl:include href="/srv/siiaf/sat/utilSat/pfic.xslt"/>
  <xsl:include href="/srv/siiaf/sat/utilSat/TuristaPasajeroExtranjero.xslt"/>
  <xsl:include href="/srv/siiaf/sat/utilSat/leyendasFisc.xslt"/>
  <xsl:include href="/srv/siiaf/sat/utilSat/spei.xslt"/>
  <xsl:include href="/srv/siiaf/sat/utilSat/nomina11.xslt"/>
  <xsl:include href="/srv/siiaf/sat/utilSat/cfdiregistrofiscal.xslt"/>
  <xsl:include href="/srv/siiaf/sat/utilSat/pagoenespecie.xslt"/>
  <xsl:include href="/srv/siiaf/sat/utilSat/consumodecombustibles.xslt"/>
  <xsl:include href="/srv/siiaf/sat/utilSat/valesdedespensa.xslt"/>
  <xsl:include href="/srv/siiaf/sat/utilSat/aerolineas.xslt"/>
  <xsl:include href="/srv/siiaf/sat/utilSat/notariospublicos.xslt"/>
